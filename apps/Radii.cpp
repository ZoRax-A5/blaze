...
struct Radii_F : public EDGEMAP_F<uint64_t> {
    Array<uint32_t>& radii;
    Array<uint64_t>& visited;
    Array<uint64_t>& nextVisited;
    int round;

    Radii_F(Array<uint32_t>& r, Array<uint64_t>& v, Array<uint64_t>& n, int ro, Bins* b):
...
struct Radii_Vertex_Init {
    ...
    Radii_Vertex_Init(Array<uint32_t>& r, Array<uint64_t>& v, Array<uint64_t>& n): 
